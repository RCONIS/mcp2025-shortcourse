...
[^1]: See also [Ensuring Quality](04_quality.qmd)
...
4.  Quality check (see [Ensuring Quality](04_quality.qmd))
...
1.  Create basic package project (see [R Packages](02_r_packages.qmd))
...
[^6]: See also [Ensuring Quality](04_quality.qmd)
